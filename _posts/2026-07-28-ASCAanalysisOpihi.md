...
* ASCA principles
	...
	* additional corrections for unbalanced data
		* if certain cells (transcripts ?) are over- or under-represented, resulting matrices are not orthogonal to each other and PCs will not describe the variation solely due to the considered factor
...
[ALASCA](https://doi.org/10.3389/fmolb.2022.962431) is an R package is useful for longitudinal data and can easily adjust covariates.
